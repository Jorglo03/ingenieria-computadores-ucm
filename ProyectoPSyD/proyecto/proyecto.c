...
//#define REC_SIZE        (320000)  /* (5,0 s) * (2 canales) * (2 B/canal) * (16000 muestras/s) */
...
//volatile uint8 beatsPerMinute;
//volatile uint8 stepsPerMinute;

//volatile ufix32 distanciaAndada;
//volatile ufix32 distanciaPaso = TOFIX(ufix32, 1.0, Q);
/*******************************************************************/
