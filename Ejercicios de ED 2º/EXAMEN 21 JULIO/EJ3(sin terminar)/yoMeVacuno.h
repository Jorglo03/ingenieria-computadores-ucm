...
private:  
   // A INCLUIR DETALLES DE REPRESENTACION
    ...
    tInfoVacunas _infoVacunas;

    typedef struct {
        Lista<tIdCiudadano> _lista_ciudadanos;
        tDireccion _dir;
    }tInfoCentro;
    ...
    Lista<tIdCiudadano> _lista_total;

    Diccionario<tIdCentro, tDireccion> _centros_ordenados;

    DiccionarioHash <tIdCentro, tInfoCentro> _centros;
    DiccionarioHash<tIdCiudadano, tInfoCiudadano> _ciudadanos;
